...
for (int i = 10; i <= 18; i++) {
	...
	try {
		...
		WebUI.setText(findTestObject('Object Repository/Page_Experian LATAMB - Preview - Sign In/input_Username_username (1)'), GlobalVariable.user_operador)
	
		WebUI.setText(findTestObject('Object Repository/Page_Experian LATAMB - Preview - Sign In/input_Password_password (1)'), GlobalVariable.password_operador)
