...
personIdNumber = accounts.getValue('personIdNumber', 60)
accountNumber = accounts.getValue('accountNumber', 60)
int nScreenshot = 0
String screenshot
...
screenshot = ('C:\\Users\\camil\\Katalon Studio\\Novedat\\Responses\\O_Masivas_Revisor_Desasignar_Corregido_por_actualización\\' + nScreenshot + '.png')
...
WebUI.scrollToElement(findTestObject('Object Repository/Page_Novedat/div_CAC 055063164130891100 FINANCIERA COMUL'), 5)

WebUI.click(findTestObject('Object Repository/Page_Novedat/div_CAC 055063164130891100 FINANCIERA COMUL'))
...
WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Novedat/select_SeleccioneCorregido por Actualizacin_2f6f5e'), '1', true)
...
WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Novedat/select_SeleccioneCaso no aplica para proces_2d5db3'), '4', true)
...
WebUI.click(findTestObject('Object Repository/Page_Novedat/span_AL0993581051'))
...
WebUI.click(findTestObject('Object Repository/Page_Novedat/input_CAC 055063164130891100 FINANCIERA COM_98135d'))

WebUI.delay(3)

WebUI.click(findTestObject('Object Repository/Page_Novedat/input_Asignar_accept-assing-modal'))
