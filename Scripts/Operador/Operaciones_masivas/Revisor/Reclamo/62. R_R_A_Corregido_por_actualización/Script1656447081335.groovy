...
personIdNumber = accounts.getValue('personIdNumber', 62)
accountNumber = accounts.getValue('accountNumber', 62)
int nScreenshot = 0
String screenshot
...
screenshot = ('C:\\Users\\camil\\Katalon Studio\\Novedat\\Responses\\62. O_Masivas\\' + nScreenshot + '.png')
...
WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Novedat/select_SeleccioneDEVOLVERAPROBARDESASIGNARR_d86014'), '5', true)

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Novedat/select_SeleccioneCorregido por Actualizacin_bd1ea0'), '1', true)

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Novedat/select_SeleccioneReclamoTipo de DocumentoTi_cb090e'), '1', true)

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Novedat/select_SeleccionePrrrogaRecurso de Reposici_6894ea'), '9', true)
...
WebUI.scrollToElement(findTestObject('Object Repository/Page_Novedat/select_SeleccioneInformacin cambio en actua_ce7fb1'), 5)

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Novedat/select_SeleccioneInformacin cambio en actua_ce7fb1'), '7', true)

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Novedat/select_Seleccione  1-Investigacin interna d_6ab5eb'), '1', true)
...
WebUI.selectOptionByValue(findTestObject('Page_Novedat/select_SeleccioneDerecho de PeticinTrmino d_6b3198'), '6', true)

WebUI.click(findTestObject('Page_Novedat/button_Enviar'))

WebUI.scrollToElement(findTestObject('Object Repository/Page_Novedat/div_TIPO  NMERO DE OBLIGACIN  ENTIDAD  F.PE_c78c56'), 5)

WebUI.click(findTestObject('Object Repository/Page_Novedat/div_TIPO  NMERO DE OBLIGACIN  ENTIDAD  F.PE_c78c56'))
