...
personIdNumber = accounts.getValue('personIdNumber', 65)
accountNumber = accounts.getValue('accountNumber', 65)
int nScreenshot = 0
String screenshot
...
screenshot = ('C:\\Users\\camil\\Katalon Studio\\Novedat\\Responses\\65. O_Masivas\\' + nScreenshot + '.png')
...
WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Novedat/select_SeleccioneCorregido por Actualizacin_80f12e'), '1', true)
...
WebUI.click(findTestObject('Object Repository/Page_Novedat/span_70005021'))
