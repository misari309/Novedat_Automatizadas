...
personIdNumber = accounts.getValue('personIdNumber', 66)
accountNumber = accounts.getValue('accountNumber', 66)
int nScreenshot = 0
String screenshot
...
screenshot = ('C:\\Users\\camil\\Katalon Studio\\Novedat\\Responses\\66. O_Masivas\\' + nScreenshot + '.png')
...
WebUI.selectOptionByValue(findTestObject('Page_Novedat/select_SeleccioneDEVOLVERAPROBARDESASIGNARR_d86014'), '2', true)

WebUI.selectOptionByValue(findTestObject('Page_Novedat/select_SeleccioneCorregido por Actualizacin_80f12e'), '5', true)
...
WebUI.setText(findTestObject('Page_Novedat/input__idNumber'), '29761041')
...
WebUI.scrollToElement(findTestObject('Object Repository/Page_Novedat/div_COC 107161221151111100 FUNDACION DE LA'), 5)
...
WebUI.click(findTestObject('Object Repository/Page_Novedat/div_COC 107161221151111100 FUNDACION DE LA'))
...
WebUI.click(findTestObject('Object Repository/Page_Novedat/span_70005027'))
