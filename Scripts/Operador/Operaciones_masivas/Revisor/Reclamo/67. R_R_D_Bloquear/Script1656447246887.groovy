...
personIdNumber = accounts.getValue('personIdNumber', 67)
accountNumber = accounts.getValue('accountNumber', 67)
int nScreenshot = 0
String screenshot
...
screenshot = ('C:\\Users\\camil\\Katalon Studio\\Novedat\\Responses\\67. O_Masivas\\' + nScreenshot + '.png')
...
WebUI.selectOptionByValue(findTestObject('Page_Novedat/select_SeleccioneCorregido por Actualizacin_80f12e'), '2', true)
...
WebUI.scrollToElement(findTestObject('Object Repository/Page_Novedat/div_CAV 432560114011105113 BCO OCCIDENTE'), 5)
...
WebUI.click(findTestObject('Object Repository/Page_Novedat/div_CAV 432560114011105113 BCO OCCIDENTE'))
...
WebUI.click(findTestObject('Object Repository/Page_Novedat/span_70005029'))
