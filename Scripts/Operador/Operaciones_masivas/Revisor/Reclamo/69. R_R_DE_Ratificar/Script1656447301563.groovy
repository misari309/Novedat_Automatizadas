...
personIdNumber = accounts.getValue('personIdNumber', 69)
accountNumber = accounts.getValue('accountNumber', 69)
int nScreenshot = 0
String screenshot
...
screenshot = ('C:\\Users\\camil\\Katalon Studio\\Novedat\\Responses\\69. O_Masivas\\' + nScreenshot + '.png')
...
WebUI.selectOptionByValue(findTestObject('Page_Novedat/select_SeleccioneCorregido por Actualizacin_5305bc'), '5', true)
...
WebUI.selectOptionByValue(findTestObject('Page_Novedat/select_SeleccioneEl cambio propuesto no es _f5f283'), '1', true)
...
WebUI.scrollToElement(findTestObject('Object Repository/Page_Novedat/div_CCS 000000116118277170 CREDITOS FINANPR'), 5)
...
WebUI.click(findTestObject('Object Repository/Page_Novedat/div_CCS 000000116118277170 CREDITOS FINANPR'))
...
WebUI.click(findTestObject('Object Repository/Page_Novedat/span_70005034'))

WebUI.click(findTestObject('Object Repository/Page_Novedat/input_CCS 000000116118277170 CREDITOS FINAN_d34f0e'))
