...
personIdNumber = accounts.getValue('personIdNumber', 70)
accountNumber = accounts.getValue('accountNumber', 70)
int nScreenshot = 0
String screenshot
...
screenshot = ('C:\\Users\\camil\\Katalon Studio\\Novedat\\Responses\\70. O_Masivas\\' + nScreenshot + '.png')
...
WebUI.selectOptionByValue(findTestObject('Page_Novedat/select_SeleccioneCorregido por Actualizacin_5305bc'), '2', true)
...
WebUI.click(findTestObject('Object Repository/Page_Novedat/span_70005045'))
...
WebUI.click(findTestObject('Object Repository/Page_Novedat/input_COC 000000111111112422 LIDERCOOP_btn _ec0769'))
...
WebUI.click(findTestObject('Page_Novedat/div_B_obligacion-notify'))
