...
nScreenshot = 0
String personIdNumber = accounts.getValue('personIdNumber', 2)
String accountNumber = accounts.getValue('accountNumber', 2)
String caseNumber = ''
...
WebUI.setText(findTestObject('Object Repository/Page_Experian LATAMB - Preview - Sign In/input_Username_username'), GlobalVariable.user_entidad)

WebUI.setText(findTestObject('Object Repository/Page_Experian LATAMB - Preview - Sign In/input_Password_password'), GlobalVariable.password_entidad)

WebUI.maximizeWindow()

//Screenshot ------------------------------------------------------------------------------------------------------------------------------------------------------------------
screenshot = ('C:\\Users\\camil\\Katalon Studio\\Novedat\\Responses\\Entidad\\2. M_Corregido_por_actualizacion\\' + nScreenshot + '.png')
